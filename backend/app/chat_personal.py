...
def simulate_existing(text, params, user, clarify, done):
    ...
    from app.chat_service import normalize, NUMBER
    ...
    return done('simulate', data, 'Kịch bản trên đúng lần học bạn chọn, không lưu hoặc thay bảng điểm. Không tạo ngày công bố giả; nếu sửa lần cũ đã bị thay, GPA hiện tại có thể không đổi.')
